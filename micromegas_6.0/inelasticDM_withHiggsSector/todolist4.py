...
def todolist1():
	...
	data1 = {'MAp':3., 'mphi':20,'Mchi1':0.1,'angle':1e-5,'gX':0.1,'epsilon':1e-4,'ff':1e-1}
	data2 = {'MAp':3., 'mphi':20,'Mchi1':0.1,'angle':1e-3,'gX':0.1,'epsilon':1e-4,'ff':1e-1}
	data3 = {'MAp':3., 'mphi':20,'Mchi1':0.1,'angle':1e-1,'gX':0.1,'epsilon':1e-4,'ff':1e-1}
	data4 = {'MAp':0.1, 'mphi':20,'Mchi1':0.1,'angle':1e-3,'gX':0.1,'epsilon':1e-4,'ff':1e-1}
	data5 = {'MAp':1, 'mphi':20,'Mchi1':0.1,'angle':1e-3,'gX':0.1,'epsilon':1e-4,'ff':1e-1}
	data6 = {'MAp':20, 'mphi':20,'Mchi1':0.1,'angle':1e-3,'gX':0.1,'epsilon':1e-4,'ff':1e-1}
	datos1 = []
	datos2 = []
	datos3 = []
	datos4 = []
	...
	info1.to_csv('doc4/info1.csv')
	info2.to_csv('doc4/info2.csv')
	info3.to_csv('doc4/info3.csv')
	info4.to_csv('doc4/info4.csv')
	info5.to_csv('doc4/info5.csv')
	info6.to_csv('doc4/info6.csv')
